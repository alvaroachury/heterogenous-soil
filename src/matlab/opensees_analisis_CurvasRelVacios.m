...
template_model_file = join([current_path, '\..\..\archivos\suelo_het_00.tcl']);
template_earthquake_file = join([current_path, '\..\..\archivos\earth_quake_0.OUT']);
...
%     corte_index = 1;
    ...
    tmp_earthquake_file = join([current_path, '\..\..\temp\', earth_quake_file]);
    ...
    %         i = 1;
        ...
        % se copian archivos relacionados con los resultados de la simulacion
    else
        message = "*** LA CARPETA " + ...
